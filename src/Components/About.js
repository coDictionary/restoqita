...
const About = () => {
  return (
    <section id="about" className="flex p-32 max-lg:p-10 max-lg:flex-col" >
      ...
      <div className="flex w-1/2 max-lg:w-fit max-lg:justify-center" data-aos="fade-up-left" data-aos-once="false">
        <img
      ...
      <div className="w-1/2 my-5 flex flex-col justify-center items-center max-lg:w-fit" data-aos="fade-up-right" data-aos-once="false">
        ...
        <div className="content-about mt-12 text-center justify-center max-lg:mt-6">
          <span className="text-sm mt-12 mb-4 text-gray-400 max-lg:text-xs">* * *</span>
